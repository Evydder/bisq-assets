...
public class ZeroOneCoinTest extends AbstractAssetTest {
    ...
    public void testInvalidAddresses() {
        assertInvalidAddress("ar17ww22Kg1cqwMasduywZWr4fCTCvxGQMb");
        assertInvalidAddress("miqeqFq9gMiCh81Kj8tqqdgsoqeqZJRfn");
        assertInvalidAddress("nN17ww22Kg1cqM2VykoDwZW4fCTCvxGQMb");
    }
}
